function [res] = runPosDecoding_wb_cheeseboard_gd(p)
%runPosDecoding_wb_cheeseboard, runs Bayesian decoder on a set of
%recordings, adds goal direction to each sweep
