function sweeps = chunkThetaPosSweeps_wb(D, dec, Y)
%chunkThetaPosSweeps_wb, determines theta sweep detection based on Bayesian
%decoded positions
%Modified from chunkThetaPosSweeps.m (Vollan et al., 2024)
...
disp(size(p))
pHpf = p-pSlow; % difference between dec fast and slow
%%
