function sweeps = chunkReplayPosSweeps_wb(D, dec, Y)
...
%%
for c = nevent:-1:1 % avoid re-allocating by running backwards
    %
    i0 = chk.iStart(c);
    i1 = chk.iEnd(c);
    ...
    % Find adjacent samples less than 20cm away
