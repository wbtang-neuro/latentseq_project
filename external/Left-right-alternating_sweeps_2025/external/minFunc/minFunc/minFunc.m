function [x,f,exitflag,output,dAll,tAll] = minFunc(funObj,x0,options,varargin)
...
%FOR MATLAB LINESEARCH
% optTol = eps(max(cast(1, "like", f), f)); %how matlab calculates it
...
for i = 1:maxIter
    ...
    elseif LS_type == 1 % Find Point satisfying Wolfe conditions
        ...
        [t,f_new,g_new,LSexitFlag,LSiter, faultTolStruct]=...
            lineSearch({'fungrad',[],funObj},x,d,f,gtd,t,c1,c2,-inf,maxFunEvals-funEvals,...
            optTol,[],finDiffFlags,sizes,g,progTol,faultTolStruct, varargin{:});
