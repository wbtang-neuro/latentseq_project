...
%%
   ...
   %angle variability vs rat speed
        [edges_speed,centers_speed] = load_timeBins([-10 240],20,20);
        % edges_speed = linspace(0,200,40); centers_speed = edges_speed(1:end-1) + mean(diff(edges_speed))/2;
        ...
        for i = 1:length(centers_speed)
            ...
            % if length(ind_thetaCycles)<10, continue, end
        ...
        ylim([10 80]), set(gca,'ytick',[0:20:80])
